...
func (x *KubeletConfiguration) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq153[113] = len(x.LocalDisks) != 0
			yyq153[114] = x.ReservedLocalDiskCapacity != 0
			var yynn153 int
			if yyr153 || yy2arr153 {
				...
				if yyq153[113] {
					if x.LocalDisks == nil {
						...
						if false {
							...
							z.F.EncSliceStringV(x.LocalDisks, false, e)
						}
					}
				} else {
					r.EncodeNil()
			...
			if yyr153 || yy2arr153 {
				...
				if yyq153[114] {
					...
					if false {
						...
						r.EncodeUint(uint64(x.ReservedLocalDiskCapacity))
					}
				} else {
					r.EncodeUint(0)
				}
				...
				if yyq153[114] {
					z.EncSendContainerState(codecSelfer_containerMapKey1234)
					r.EncodeString(codecSelferC_UTF81234, string("reservedLocalDiskCapacity"))
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					yym520 := z.EncBinary()
					_ = yym520
					if false {
	...
	for yyj523 := 0; ; yyj523++ {
		...
		case "outOfDiskTransitionFrequency":
			if r.TryDecodeAsNil() {
				...
				yyv625 := &x.OutOfDiskTransitionFrequency
				yym626 := z.DecBinary()
				_ = yym626
				if false {
		...
		case "evictionPressureTransitionPeriod":
			if r.TryDecodeAsNil() {
				...
				yyv635 := &x.EvictionPressureTransitionPeriod
				yym636 := z.DecBinary()
				_ = yym636
				if false {
		...
		case "kubeReserved":
			if r.TryDecodeAsNil() {
				...
				yyv643 := &x.KubeReserved
				yym644 := z.DecBinary()
				_ = yym644
				if false {
				} else if z.HasExtensions() && z.DecExt(yyv643) {
				} else {
					h.decconfig_ConfigurationMap((*pkg2_config.ConfigurationMap)(yyv643), d)
				}
			}
		...
		case "reservedLocalDiskCapacity":
			if r.TryDecodeAsNil() {
				x.ReservedLocalDiskCapacity = 0
			} else {
				x.ReservedLocalDiskCapacity = uint32(r.DecodeUint(32))
			}
		default:
...
func (x *KubeletConfiguration) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			z.F.DecMapStringStringX(yyv763, false, d)
		}
	}
	yyj658++
	if yyhl658 {
	...
	if r.TryDecodeAsNil() {
		...
		yyv778 := &x.KubeReserved
		yym779 := z.DecBinary()
		_ = yym779
		if false {
		} else if z.HasExtensions() && z.DecExt(yyv778) {
		} else {
			h.decconfig_ConfigurationMap((*pkg2_config.ConfigurationMap)(yyv778), d)
		}
	}
	yyj658++
	if yyhl658 {
	...
	if r.TryDecodeAsNil() {
		...
		yyv784 := &x.AllowedUnsafeSysctls
		yym785 := z.DecBinary()
		_ = yym785
		if false {
		} else {
			z.F.DecSliceStringX(yyv784, false, d)
		}
	}
	yyj658++
	if yyhl658 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			z.F.DecSliceStringX(yyv790, false, d)
		}
	}
	yyj658++
	if yyhl658 {
...
func (x *KubeSchedulerConfiguration) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			if yyr897 || yy2arr897 {
				z.EncSendContainerState(codecSelfer_containerArrayElem1234)
				yy938 := &x.LeaderElection
				yy938.CodecEncodeSelf(e)
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey1234)
				r.EncodeString(codecSelferC_UTF81234, string("leaderElection"))
				z.EncSendContainerState(codecSelfer_containerMapValue1234)
				yy939 := &x.LeaderElection
	...
	for yyj942 := 0; ; yyj942++ {
		...
		case "leaderElection":
			if r.TryDecodeAsNil() {
				...
				yyv956 := &x.LeaderElection
				yyv956.CodecDecodeSelf(d)
			}
		default:
